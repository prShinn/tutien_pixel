...
const EQ_GRADES = {
	THUONG: { n: "", c: "var(--g0)", s: "Trắng" },
	BAO_KHI: { n: "Bảo Khí", c: "var(--g1)", s: "Lục" },
	LINH_KHI: { n: "Linh Khí", c: "var(--g2)", s: "Lam" },
	THANH_KHI: { n: "Thánh Khí", c: "var(--g3)", s: "Tím" },
	THAN_KHI: { n: "Thần Khí", c: "var(--g4)", s: "Cam" },
	DE_KHI: { n: "Đế Bảo", c: "var(--g5)", s: "Vàng" },
	TRUYEN_THUYET: { n: "Đế Khí", c: "var(--g5)", s: "Đỏ" },
};
const SOLID = new Set([T.WALL, T.WATER, T.TREE, T.MTN]);
const otherPlayers = new Map();
function isSolid(tx, ty) {
	if (tx < 0 || ty < 0 || tx >= GameState.mapW || ty >= GameState.mapH) return true;
...
>>>>>>> 222eefbef6f053149f0e4959dc313c217137d46d
